  ...
  func rejectsInvalidCommands() {
    let invalidCommands:
      [(line: String, result: pdsim_agent_command_parse_result, message: String)] = [
        ("button 3 1", pdsim_agent_command_parse_invalid_button, "error invalid button command"),
        ("press 32 0", pdsim_agent_command_parse_invalid_press, "error invalid press command"),
        ("press 32 10001", pdsim_agent_command_parse_invalid_press, "error invalid press command"),
        ("crank 361", pdsim_agent_command_parse_invalid_crank, "error invalid crank command"),
        (
          "crank-docked 2",
